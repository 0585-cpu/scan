...
- Confirm both Cargo lockfiles, `desktop/src-tauri/Cargo.toml`, `desktop/src-tauri/tauri.conf.json`, `desktop/package.json`, and the root entries in `desktop/package-lock.json` match that version.
